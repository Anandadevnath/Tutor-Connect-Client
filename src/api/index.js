...
export const api = {
    ...
    getTutorialById: (id, token) => apiFetch(`/api/tutorials/${id}`, { headers: { Authorization: `Bearer ${token}` } }),
    addTutorial: (data, token) => apiFetch('/api/tutorials', { method: 'POST', headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` }, body: JSON.stringify(data) }),
    updateTutorial: (id, data, token) => apiFetch(`/api/tutorials/${id}`, { method: 'PUT', headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` }, body: JSON.stringify(data) }),
    ...
    register: (data) => apiFetch('/api/register', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(data) }),
    googleLogin: (data) => apiFetch('/api/google-login', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(data) }),
    // Stats
